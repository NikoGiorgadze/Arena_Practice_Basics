...
$$b_t=\mu b_{t-1}+\tilde g_t, \qquad \theta_t=\theta_{t-1}-\eta b_t.$$
...
$$\mathcal L_{\mathrm{mech}} = \frac12\dot\theta^TM\dot\theta-L(\theta), \qquad \mathcal R = \frac12\dot\theta^T\Gamma\dot\theta.$$
...
$$v_t = \alpha v_{t-1}+(1-\alpha)\tilde g_t^2, \qquad q_t = \frac{\tilde g_t}{\sqrt{v_t}+\epsilon}.$$

If momentum is enabled, it then applies

$$b_t=\mu b_{t-1}+q_t, \qquad \theta_t=\theta_{t-1}-\eta b_t;$$
...
$$v_t = (1-\alpha)\sum_{j=0}^{t-1}\alpha^j\tilde g_{t-j}^2.$$
...
$$m_t = \beta_1m_{t-1}+(1-\beta_1)\tilde g_t, \qquad v_t = \beta_2v_{t-1}+(1-\beta_2)\tilde g_t^2.$$
...
$$\tau_m\dot m=\tilde g-m, \qquad \tau_v\dot v=\tilde g^2-v.$$
